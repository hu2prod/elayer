      ...
      while (cur = stack.pop()) {
        ...
        switch (hki) {
          ...
          case 24:
            ...
            /* rule_Hrvalue_ultEdeep_tiEpass__u4 */
            ...
            /* rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_XX1Xtail_space_u121 */
          ...
          case 116:
            ...
            /* rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_HstmtXultEEdirective_fn_call_u122 queue */
          ...
          case 117:
            ...
            /* rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_HstmtXultEEdirective_fn_call_u122 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (_dz = 0, _len104 = list_1.length; _dz < _len104; _dz++) {
              ...
              for (_ea = 0, _len105 = list_2.length; _ea < _len105; _ea++) {
                ...
                for (_eb = 0, _len106 = list_3.length; _eb < _len106; _eb++) {
                  ...
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_HstmtXultEEdirective_fn_call_u122";
                  mx_hash_stub.hash_key = "rvalue";
                  mx_hash_stub.hash_key_idx = 23;
                  mx_hash_stub["priority"] = arg_list[1].mx_hash.priority;
                  mx_hash_stub["ult"] = "bin_op";
          ...
          case 119:
            ...
            /* rule_Hrvalue_ultEdeep_tiEpass__u4 queue */
          ...
          case 120:
            ...
            /* rule_Hrvalue_ultEdeep_tiEpass__u4 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (_ec = 0, _len107 = list_1.length; _ec < _len107; _ec++) {
              ...
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Hrvalue_ultEdeep_tiEpass__u4";
          ...
          case 157:
            ...
            /* rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_XX1Xtail_space_u121 queue */
          ...
          case 158:
            ...
            /* rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_XX1Xtail_space_u121 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_lq = 0, _len279 = hyp_list_3.length; _lq < _len279; _lq++) {
                  ...
                  for (_lr = 0, _len280 = list_4.length; _lr < _len280; _lr++) {
                    ...
                    for (_ls = 0, _len281 = list_5.length; _ls < _len281; _ls++) {
                      ...
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_XX1Xtail_space_u121";
                      mx_hash_stub.hash_key = "stmt";
                      mx_hash_stub.hash_key_idx = 24;
                      mx_hash_stub["priority"] = -9000;
                      mx_hash_stub["ult"] = "directive_fn_call";
