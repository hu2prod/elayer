  ...
  this.Parser = (function() {
    ...
    Parser.prototype.go = function(token_list_list) {
      ...
      for (idx = _bv = 0, _len62 = token_list_list.length; _bv < _len62; idx = ++_bv) {
        ...
        arg_list = node.value_array;
        mx_hash_stub = node.mx_hash = {};
        mx_hash_stub.rule = "rule_XXXX_ultEmacro_tiEmacro_eolE1__u124";
        ...
        node.b = node.value_array.last().b;
        _pos_list = this.cache[idx];
        if (_pos_list[44] == null) {
          _pos_list[44] = [];
        }
        _pos_list[44].push(node);
      }
      for (idx = _bw = 0, _len63 = token_list_list.length; _bw < _len63; idx = ++_bw) {
        ...
        arg_list = node.value_array;
        mx_hash_stub = node.mx_hash = {};
        mx_hash_stub.rule = "rule_XXXXX_ultEmacro_tiEmacro_eolE1__u125";
        mx_hash_stub.hash_key = "ranger";
        mx_hash_stub.hash_key_idx = 44;
        mx_hash_stub["ult"] = "macro";
        mx_hash_stub["ti"] = "macro";
      ...
      while (cur = stack.pop()) {
        ...
        switch (hki) {
          ...
          case 24:
            ...
            /* rule_Harray_init_priorityEX9000_ultEarray_init__u115 */
            stack.push([123, start_pos, only_new]);

            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_priorityEX9000_ultEcl_decl__u141 */
            stack.push([125, start_pos, only_new]);

            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u142 */
            stack.push([127, start_pos, only_new]);

            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u143 */
            stack.push([129, start_pos, only_new]);

            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_priorityEX9000_ultEcl_decl__u144 */
            stack.push([131, start_pos, only_new]);

            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u145 */
            stack.push([133, start_pos, only_new]);

            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u146 */
            stack.push([135, start_pos, only_new]);

            /* rule_Hrvalue_XXX_Hfn_call_arg_listO_XXX_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_u151 */
            stack.push([137, start_pos, only_new]);

            /* rule_Hrvalue_Hfn_call_arg_list_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_X1Xtail_space_u152 */
            stack.push([139, start_pos, only_new]);

            /* rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_eolE1_HstmtXultEEdirective_fn_call_u156 */
          ...
          case 25:
            ...
            /* rule_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEif_tiEif_eolE1__u116 */
            stack.push([152, start_pos, only_new]);

            /* rule_Hstmt_if_Hrvalue_ultEif_postfix_tiEif_postfix_eolE1__u120 */
            stack.push([154, start_pos, only_new]);

            /* rule_switch_Hrvalue_Hindent_Hswitch_tail_stmt_Hdedent_ultEswitch_tiEswitch_eolE1__u121 */
            stack.push([156, start_pos, only_new]);

            /* rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_Hblock_ultEfor_range_tiEmacro_eolE1__u126 */
            stack.push([158, start_pos, only_new]);

            /* rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_by_Hrvalue_Hblock_ultEfor_range_tiEmacro_eolE1__u127 */
            stack.push([160, start_pos, only_new]);

            /* rule_for_Htok_identifier___________________in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u128 */
            stack.push([162, start_pos, only_new]);

            /* rule_for_Htok_identifier_XXX_Htok_identifier_in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u129 */
            stack.push([164, start_pos, only_new]);

            /* rule_Hreturn_HrvalueO_ultEreturn_tiEreturn__u134 */
            stack.push([166, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_ultEfn_decl__u135 */
            stack.push([168, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hblock_ultEfn_decl_eolE1__u136 */
            stack.push([170, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hrvalue_ultEfn_decl__u137 */
            stack.push([172, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_ultEfn_decl__u138 */
            stack.push([174, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hblock_ultEfn_decl_eolE1__u139 */
            stack.push([176, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hrvalue_ultEfn_decl__u140 */
            stack.push([178, start_pos, only_new]);

            /* rule_class_Htok_identifier_ultEclass_decl__u147 */
            stack.push([180, start_pos, only_new]);

            /* rule_class_Htok_identifier_Hblock_ultEclass_decl_eolE1__u148 */
            stack.push([182, start_pos, only_new]);

            /* rule_Hlvalue_Hblock_ultEdirective_fn_call_tiEmacro_eolE1__u153 */
            stack.push([184, start_pos, only_new]);

            /* rule_Hlvalue_Hfn_call_arg_list_Hblock_ultEdirective_fn_call_tiEmacro_eolE1_XXX1Xtail_space_u154 */
            stack.push([186, start_pos, only_new]);

            /* rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_eolE1_XX1Xtail_space_u155 */
          ...
          case 35:
            ...
            /* rule_Htok_identifier_Htype_nestO_Htype_fieldO_ultEtype_name_tiEpass__u164 */
          ...
          case 36:
            ...
            /* rule_Hreturn_XXX_Hrvalue_eolEHrvalueXeol__u107 */
            stack.push([223, start_pos, only_new]);

            /* rule_H__XXX_Hrvalue_eolEHrvalueXeol_X1Xremap_u108 */
          ...
          case 238:
            ...
            /* rule_Hstruct_init_kv_XXX_Heol_Hstruct_init_list_struct_init_inlineE0__u101 */
            node_list.append(FAcache[start_pos][236]);
          ...
          case 40:
            ...
            /* rule_Hrvalue_Heol_____Harray_init_list___u110 */
            stack.push([251, start_pos, only_new]);

            /* rule_Hrvalue_XXX______Harray_init_list___u111 */
            stack.push([253, start_pos, only_new]);

            /* rule_Hrvalue_XXX_Heol_Harray_init_list___u112 */
          ...
          case 41:
            ...
            /* rule_XXX_Harray_init_listO_XXX___u113 */
            stack.push([258, start_pos, only_new]);

            /* rule_XXX_Hindent_Harray_init_listO_Hdedent_XXX___u114 */
          ...
          case 42:
            ...
            /* rule_else_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u117 */
            stack.push([263, start_pos, only_new]);

            /* rule_elseifXelsifXelif_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u118 */
            stack.push([265, start_pos, only_new]);

            /* rule_else_Hblock_ultEelse_tiEelse_eolE1__u119 */
          ...
          case 43:
            ...
            /* rule_when_Hrvalue_Hblock_Hswitch_tail_stmtO_ultEswitch_when_tiEswitch_when_eolE1__u122 */
            stack.push([270, start_pos, only_new]);

            /* rule_else_Hblock_ultEswitch_else_tiEswitch_else_eolE1__u123 */
            stack.push([272, start_pos, only_new]);
            break;
          case 274:
            ...
            /* rule_when_Hrvalue_Hblock_Hswitch_tail_stmtO_ultEswitch_when_tiEswitch_when_eolE1__u122 */
            node_list.append(FAcache[start_pos][270]);

            /* rule_else_Hblock_ultEswitch_else_tiEswitch_else_eolE1__u123 */
            node_list.append(FAcache[start_pos][272]);
          ...
          case 45:
            ...
            /* rule_Htok_identifier_XXX_Htype___u130 */
            stack.push([276, start_pos, only_new]);

            /* rule_Htok_identifier___u131 */
          ...
          case 46:
            ...
            /* rule_Hfn_decl_arg___u132 */
            stack.push([281, start_pos, only_new]);

            /* rule_Hfn_decl_arg_XXX_Hfn_decl_arg_list___u133 */
            stack.push([283, start_pos, only_new]);
            break;
          case 285:
            ...
            /* rule_Hfn_decl_arg___u132 */
            node_list.append(FAcache[start_pos][281]);

            /* rule_Hfn_decl_arg_XXX_Hfn_decl_arg_list___u133 */
            node_list.append(FAcache[start_pos][283]);
          ...
          case 47:
            ...
            stack.push([290, start_pos, only_new]);

            /* rule_Hrvalue_bracketless_hashEX1Xbracketless_hash__u149 */
            stack.push([286, start_pos, only_new]);

            /* rule_Hrvalue_XXX_Hfn_call_arg_list_bracketless_hashEX1Xbracketless_hash_XX1Xbracketless_hashXXXX3Xbracketless_hash_u150 */
            stack.push([288, start_pos, only_new]);
            break;
          case 290:
            ...
            /* rule_Hrvalue_bracketless_hashEX1Xbracketless_hash__u149 */
            node_list.append(FAcache[start_pos][286]);

            /* rule_Hrvalue_XXX_Hfn_call_arg_list_bracketless_hashEX1Xbracketless_hash_XX1Xbracketless_hashXXXX3Xbracketless_hash_u150 */
            node_list.append(FAcache[start_pos][288]);
          ...
          case 48:
            ...
            /* rule_Htype_XXX_Htype_list___u158 */
            stack.push([293, start_pos, only_new]);
            break;
          case 295:
            ...
            /* rule_Htype___u157 */
            node_list.append(FAcache[start_pos][291]);

            /* rule_Htype_XXX_Htype_list___u158 */
            node_list.append(FAcache[start_pos][293]);
          ...
          case 49:
            ...
            /* rule_XXX_Htype_list_XXX___u159 */
            stack.push([296, start_pos, only_new]);
            break;
          case 298:
            ...
            /* rule_XXX_Htype_list_XXX___u159 */
            node_list.append(FAcache[start_pos][296]);
          ...
          case 50:
            ...
            stack.push([301, start_pos, only_new]);

            /* rule_Htok_identifier_XXX_Htype___u160 */
            stack.push([299, start_pos, only_new]);
            break;
          case 301:
            ...
            /* rule_Htok_identifier_XXX_Htype___u160 */
            node_list.append(FAcache[start_pos][299]);
          ...
          case 51:
            ...
            stack.push([306, start_pos, only_new]);

            /* rule_Htype_field_kv___u161 */
            stack.push([302, start_pos, only_new]);

            /* rule_Htype_field_kv_XXX_Htype_field_kv_list___u162 */
            stack.push([304, start_pos, only_new]);
            break;
          case 306:
            ...
            /* rule_Htype_field_kv___u161 */
            node_list.append(FAcache[start_pos][302]);

            /* rule_Htype_field_kv_XXX_Htype_field_kv_list___u162 */
            node_list.append(FAcache[start_pos][304]);
          ...
          case 52:
            ...
            stack.push([309, start_pos, only_new]);

            /* rule_XXX_Htype_field_kv_listO_XXX___u163 */
            stack.push([307, start_pos, only_new]);
            break;
          case 309:
            ...
            /* rule_XXX_Htype_field_kv_listO_XXX___u163 */
            node_list.append(FAcache[start_pos][307]);
          ...
          case 123:
            ...
            /* rule_Harray_init_priorityEX9000_ultEarray_init__u115 queue */
          ...
          case 124:
            ...
            /* rule_Harray_init_priorityEX9000_ultEarray_init__u115 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _bu = _ref66 = FAcounter[b_0][59], _ref67 = list_1.length; _bu < _ref67; idx_1 = _bu += 1) {
              ...
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Harray_init_priorityEX9000_ultEarray_init__u115";
              mx_hash_stub.hash_key = "rvalue";
              mx_hash_stub.hash_key_idx = 24;
              mx_hash_stub["priority"] = -9000;
          ...
          case 125:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_priorityEX9000_ultEcl_decl__u141 queue */
          ...
          case 126:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_priorityEX9000_ultEcl_decl__u141 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                  ...
                  for (_ci = 0, _len36 = list_4.length; _ci < _len36; _ci++) {
                    ...
                    for (_cj = 0, _len37 = list_5.length; _cj < _len37; _cj++) {
                      ...
                      for (_ck = 0, _len38 = list_6.length; _ck < _len38; _ck++) {
                        ...
                        arg_list = node.value_array;
                        mx_hash_stub = node.mx_hash = {};
                        mx_hash_stub.rule = "rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_priorityEX9000_ultEcl_decl__u141";
                        mx_hash_stub.hash_key = "rvalue";
                        mx_hash_stub.hash_key_idx = 24;
                        mx_hash_stub["priority"] = -9000;
          ...
          case 127:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u142 queue */
          ...
          case 128:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u142 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                    ...
                    for (_db = 0, _len49 = list_5.length; _db < _len49; _db++) {
                      ...
                      for (_dc = 0, _len50 = list_6.length; _dc < _len50; _dc++) {
                        ...
                        for (_dd = 0, _len51 = list_7.length; _dd < _len51; _dd++) {
                          ...
                          arg_list = node.value_array;
                          mx_hash_stub = node.mx_hash = {};
                          mx_hash_stub.rule = "rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u142";
                          mx_hash_stub.hash_key = "rvalue";
                          mx_hash_stub.hash_key_idx = 24;
                          mx_hash_stub["priority"] = -9000;
                          mx_hash_stub["ult"] = "cl_decl";
          ...
          case 129:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u143 queue */
          ...
          case 130:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u143 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                    ...
                    for (_du = 0, _len62 = list_5.length; _du < _len62; _du++) {
                      ...
                      for (_dv = 0, _len63 = list_6.length; _dv < _len63; _dv++) {
                        ...
                        for (_dw = 0, _len64 = list_7.length; _dw < _len64; _dw++) {
                          ...
                          arg_list = node.value_array;
                          mx_hash_stub = node.mx_hash = {};
                          mx_hash_stub.rule = "rule_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u143";
                          mx_hash_stub.hash_key = "rvalue";
                          mx_hash_stub.hash_key_idx = 24;
                          mx_hash_stub["priority"] = -9000;
                          mx_hash_stub["ult"] = "cl_decl";
          ...
          case 131:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_priorityEX9000_ultEcl_decl__u144 queue */
          ...
          case 132:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_priorityEX9000_ultEcl_decl__u144 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
              ...
              for (_eg = 0, _len68 = hyp_list_2.length; _eg < _len68; _eg++) {
                ...
                for (_eh = 0, _len69 = list_3.length; _eh < _len69; _eh++) {
                  ...
                  for (_ei = 0, _len70 = list_4.length; _ei < _len70; _ei++) {
                    ...
                    arg_list = node.value_array;
                    mx_hash_stub = node.mx_hash = {};
                    mx_hash_stub.rule = "rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_priorityEX9000_ultEcl_decl__u144";
                    mx_hash_stub.hash_key = "rvalue";
                    mx_hash_stub.hash_key_idx = 24;
                    mx_hash_stub["priority"] = -9000;
                    mx_hash_stub["ult"] = "cl_decl";
          ...
          case 133:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u145 queue */
          ...
          case 134:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u145 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_ev = 0, _len77 = list_3.length; _ev < _len77; _ev++) {
                  ...
                  for (_ew = 0, _len78 = list_4.length; _ew < _len78; _ew++) {
                    ...
                    for (_ex = 0, _len79 = list_5.length; _ex < _len79; _ex++) {
                      ...
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hblock_priorityEX9000_ultEcl_decl_eolE1__u145";
                      mx_hash_stub.hash_key = "rvalue";
                      mx_hash_stub.hash_key_idx = 24;
                      mx_hash_stub["priority"] = -9000;
                      mx_hash_stub["ult"] = "cl_decl";
          ...
          case 135:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u146 queue */
          ...
          case 136:
            ...
            /* rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u146 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_fk = 0, _len86 = list_3.length; _fk < _len86; _fk++) {
                  ...
                  for (_fl = 0, _len87 = list_4.length; _fl < _len87; _fl++) {
                    ...
                    for (_fm = 0, _len88 = list_5.length; _fm < _len88; _fm++) {
                      ...
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_XXX_Hfn_decl_arg_listO_XXX__XEXX_Hrvalue_priorityEX9000_ultEcl_decl__u146";
                      mx_hash_stub.hash_key = "rvalue";
                      mx_hash_stub.hash_key_idx = 24;
                      mx_hash_stub["priority"] = -9000;
                      mx_hash_stub["ult"] = "cl_decl";
          ...
          case 137:
            ...
            /* rule_Hrvalue_XXX_Hfn_call_arg_listO_XXX_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_u151 queue */
          ...
          case 138:
            ...
            /* rule_Hrvalue_XXX_Hfn_call_arg_listO_XXX_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_u151 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
              ...
              for (_fu = 0, _len92 = list_2.length; _fu < _len92; _fu++) {
                ...
                for (_fy = 0, _len94 = hyp_list_3.length; _fy < _len94; _fy++) {
                  ...
                  for (_fz = 0, _len95 = list_4.length; _fz < _len95; _fz++) {
                    ...
                    mx_hash_stub = node.mx_hash = {};
                    mx_hash_stub.rule = "rule_Hrvalue_XXX_Hfn_call_arg_listO_XXX_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_u151";
                    mx_hash_stub.hash_key = "rvalue";
                    mx_hash_stub.hash_key_idx = 24;
                    mx_hash_stub["priority"] = -9000;
          ...
          case 139:
            ...
            /* rule_Hrvalue_Hfn_call_arg_list_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_X1Xtail_space_u152 queue */
          ...
          case 140:
            ...
            /* rule_Hrvalue_Hfn_call_arg_list_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_X1Xtail_space_u152 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _gb = _ref98 = FAcounter[b_0][129], _ref99 = list_1.length; _gb < _ref99; idx_1 = _gb += 1) {
              ...
              for (_gc = 0, _len96 = list_2.length; _gc < _len96; _gc++) {
                ...
                mx_hash_stub = node.mx_hash = {};
                mx_hash_stub.rule = "rule_Hrvalue_Hfn_call_arg_list_priorityEX9000_ultEfn_call_X1XpriorityEEX9000_X1Xtail_space_u152";
                mx_hash_stub.hash_key = "rvalue";
                mx_hash_stub.hash_key_idx = 24;
                mx_hash_stub["priority"] = -9000;
                mx_hash_stub["ult"] = "fn_call";
          ...
          case 141:
            ...
            /* rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_eolE1_HstmtXultEEdirective_fn_call_u156 queue */
          ...
          case 142:
            ...
            /* rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_eolE1_HstmtXultEEdirective_fn_call_u156 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _gf = _ref102 = FAcounter[b_0][134], _ref103 = list_1.length; _gf < _ref103; idx_1 = _gf += 1) {
              ...
              for (_gg = 0, _len98 = list_2.length; _gg < _len98; _gg++) {
                ...
                for (_gh = 0, _len99 = list_3.length; _gh < _len99; _gh++) {
                  ...
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hlvalue_Hbin_op_Hstmt_priorityEHbin_opXpriority_ultEbin_op_tiEbin_op_eolE1_HstmtXultEEdirective_fn_call_u156";
                  mx_hash_stub.hash_key = "rvalue";
                  mx_hash_stub.hash_key_idx = 24;
                  mx_hash_stub["priority"] = arg_list[1].mx_hash.priority;
                  mx_hash_stub["ult"] = "bin_op";
          ...
          case 152:
            ...
            /* rule_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEif_tiEif_eolE1__u116 queue */
          ...
          case 153:
            ...
            /* rule_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEif_tiEif_eolE1__u116 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
              ...
              for (_ha = 0, _len109 = list_2.length; _ha < _len109; _ha++) {
                ...
                for (_hb = 0, _len110 = list_3.length; _hb < _len110; _hb++) {
                  ...
                  for (_hf = 0, _len112 = hyp_list_4.length; _hf < _len112; _hf++) {
                    ...
                    arg_list = node.value_array;
                    mx_hash_stub = node.mx_hash = {};
                    mx_hash_stub.rule = "rule_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEif_tiEif_eolE1__u116";
                    mx_hash_stub.hash_key = "stmt";
                    mx_hash_stub.hash_key_idx = 25;
                    mx_hash_stub["ult"] = "if";
                    mx_hash_stub["ti"] = "if";
          ...
          case 154:
            ...
            /* rule_Hstmt_if_Hrvalue_ultEif_postfix_tiEif_postfix_eolE1__u120 queue */
          ...
          case 155:
            ...
            /* rule_Hstmt_if_Hrvalue_ultEif_postfix_tiEif_postfix_eolE1__u120 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _hi = _ref120 = FAcounter[b_0][157], _ref121 = list_1.length; _hi < _ref121; idx_1 = _hi += 1) {
              ...
              for (_hj = 0, _len114 = list_2.length; _hj < _len114; _hj++) {
                ...
                for (_hk = 0, _len115 = list_3.length; _hk < _len115; _hk++) {
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hstmt_if_Hrvalue_ultEif_postfix_tiEif_postfix_eolE1__u120";
                  mx_hash_stub.hash_key = "stmt";
                  mx_hash_stub.hash_key_idx = 25;
          ...
          case 156:
            ...
            /* rule_switch_Hrvalue_Hindent_Hswitch_tail_stmt_Hdedent_ultEswitch_tiEswitch_eolE1__u121 queue */
            ...
            for (idx_1 = _hl = _ref122 = FAcounter[b_0][161], _ref123 = list_1.length; _hl < _ref123; idx_1 = _hl += 1) {
              ...
              for (_hm = 0, _len116 = list_2.length; _hm < _len116; _hm++) {
                ...
                for (_hn = 0, _len117 = list_3.length; _hn < _len117; _hn++) {
                  ...
                  state_4 = FAstate[b_3][43];
                  if (state_4 !== STATE_FL) {
                    if (request_make(43, b_3, 0)) {
                      continue;
                    }
                  }
                  list_4 = FAcache[b_3][43];
          ...
          case 157:
            ...
            /* rule_switch_Hrvalue_Hindent_Hswitch_tail_stmt_Hdedent_ultEswitch_tiEswitch_eolE1__u121 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_hr = 0, _len120 = list_3.length; _hr < _len120; _hr++) {
                  ...
                  for (_hs = 0, _len121 = list_4.length; _hs < _len121; _hs++) {
                    ...
                    for (_ht = 0, _len122 = list_5.length; _ht < _len122; _ht++) {
                      ...
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_switch_Hrvalue_Hindent_Hswitch_tail_stmt_Hdedent_ultEswitch_tiEswitch_eolE1__u121";
                      mx_hash_stub.hash_key = "stmt";
                      mx_hash_stub.hash_key_idx = 25;
          ...
          case 158:
            ...
            /* rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_Hblock_ultEfor_range_tiEmacro_eolE1__u126 queue */
                ...
                for (_hw = 0, _len124 = list_3.length; _hw < _len124; _hw++) {
                  ...
                  for (_hx = 0, _len125 = list_4.length; _hx < _len125; _hx++) {
                    ...
                    for (_hy = 0, _len126 = list_5.length; _hy < _len126; _hy++) {
                      ...
                      state_6 = FAstate[b_5][44];
                      if (state_6 !== STATE_FL) {
                        if (request_make(44, b_5, 0)) {
                          continue;
                        }
                      }
                      list_6 = FAcache[b_5][44];
          ...
          case 159:
            ...
            /* rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_Hblock_ultEfor_range_tiEmacro_eolE1__u126 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                        ...
                        for (_ii = 0, _len135 = list_7.length; _ii < _len135; _ii++) {
                          ...
                          for (_ij = 0, _len136 = list_8.length; _ij < _len136; _ij++) {
                            ...
                            for (_ik = 0, _len137 = list_9.length; _ik < _len137; _ik++) {
                              ...
                              arg_list = node.value_array;
                              mx_hash_stub = node.mx_hash = {};
                              mx_hash_stub.rule = "rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_Hblock_ultEfor_range_tiEmacro_eolE1__u126";
                              mx_hash_stub.hash_key = "stmt";
                              mx_hash_stub.hash_key_idx = 25;
          ...
          case 160:
            ...
            /* rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_by_Hrvalue_Hblock_ultEfor_range_tiEmacro_eolE1__u127 queue */
          ...
          case 161:
            ...
            /* rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_by_Hrvalue_Hblock_ultEfor_range_tiEmacro_eolE1__u127 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                            ...
                            for (_jd = 0, _len154 = list_9.length; _jd < _len154; _jd++) {
                              ...
                              for (_je = 0, _len155 = list_10.length; _je < _len155; _je++) {
                                ...
                                for (_jf = 0, _len156 = list_11.length; _jf < _len156; _jf++) {
                                  ...
                                  arg_list = node.value_array;
                                  mx_hash_stub = node.mx_hash = {};
                                  mx_hash_stub.rule = "rule_for_Htok_identifier_in_XXX_Hrvalue_Hranger_Hrvalue_XXX_by_Hrvalue_Hblock_ultEfor_range_tiEmacro_eolE1__u127";
                                  mx_hash_stub.hash_key = "stmt";
                                  mx_hash_stub.hash_key_idx = 25;
                                  mx_hash_stub["ult"] = "for_range";
                                  mx_hash_stub["ti"] = "macro";
          ...
          case 162:
            ...
            /* rule_for_Htok_identifier___________________in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u128 queue */
          ...
          case 163:
            ...
            /* rule_for_Htok_identifier___________________in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u128 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_jm = 0, _len161 = list_3.length; _jm < _len161; _jm++) {
                  ...
                  for (_jn = 0, _len162 = list_4.length; _jn < _len162; _jn++) {
                    ...
                    for (_jo = 0, _len163 = list_5.length; _jo < _len163; _jo++) {
                      ...
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_for_Htok_identifier___________________in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u128";
                      mx_hash_stub.hash_key = "stmt";
                      mx_hash_stub.hash_key_idx = 25;
          ...
          case 164:
            ...
            /* rule_for_Htok_identifier_XXX_Htok_identifier_in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u129 queue */
          ...
          case 165:
            ...
            /* rule_for_Htok_identifier_XXX_Htok_identifier_in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u129 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                    ...
                    for (_jz = 0, _len172 = list_5.length; _jz < _len172; _jz++) {
                      ...
                      for (_ka = 0, _len173 = list_6.length; _ka < _len173; _ka++) {
                        ...
                        for (_kb = 0, _len174 = list_7.length; _kb < _len174; _kb++) {
                          ...
                          arg_list = node.value_array;
                          mx_hash_stub = node.mx_hash = {};
                          mx_hash_stub.rule = "rule_for_Htok_identifier_XXX_Htok_identifier_in_Hrvalue_Hblock_ultEfor_col_tiEmacro_eolE1__u129";
                          mx_hash_stub.hash_key = "stmt";
                          mx_hash_stub.hash_key_idx = 25;
                          mx_hash_stub["ult"] = "for_col";
                          mx_hash_stub["ti"] = "macro";
          ...
          case 166:
            ...
            /* rule_Hreturn_HrvalueO_ultEreturn_tiEreturn__u134 queue */
            chk_len = stack.push([166, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            state_1 = FAstate[b_0][39];
            if (state_1 !== STATE_FL) {
              if (request_make(39, b_0, 0)) {
                continue;
              }
            }
            list_1 = FAcache[b_0][39];
          ...
          case 167:
            ...
            /* rule_Hreturn_HrvalueO_ultEreturn_tiEreturn__u134 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _kh = _ref144 = FAcounter[b_0][230], _ref145 = list_1.length; _kh < _ref145; idx_1 = _kh += 1) {
              ...
              for (_kl = 0, _len178 = hyp_list_2.length; _kl < _len178; _kl++) {
                ...
                arg_list = node.value_array;
                mx_hash_stub = node.mx_hash = {};
                mx_hash_stub.rule = "rule_Hreturn_HrvalueO_ultEreturn_tiEreturn__u134";
                mx_hash_stub.hash_key = "stmt";
                mx_hash_stub.hash_key_idx = 25;
          ...
          case 168:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_ultEfn_decl__u135 queue */
          ...
          case 169:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_ultEfn_decl__u135 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                    ...
                    for (_lb = 0, _len188 = list_5.length; _lb < _len188; _lb++) {
                      ...
                      for (_lc = 0, _len189 = list_6.length; _lc < _len189; _lc++) {
                        ...
                        for (_ld = 0, _len190 = list_7.length; _ld < _len190; _ld++) {
                          ...
                          arg_list = node.value_array;
                          mx_hash_stub = node.mx_hash = {};
                          mx_hash_stub.rule = "rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_ultEfn_decl__u135";
                          mx_hash_stub.hash_key = "stmt";
                          mx_hash_stub.hash_key_idx = 25;
          ...
          case 170:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hblock_ultEfn_decl_eolE1__u136 queue */
          ...
          case 171:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hblock_ultEfn_decl_eolE1__u136 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                      ...
                      for (_lw = 0, _len203 = list_6.length; _lw < _len203; _lw++) {
                        ...
                        for (_lx = 0, _len204 = list_7.length; _lx < _len204; _lx++) {
                          ...
                          for (_ly = 0, _len205 = list_8.length; _ly < _len205; _ly++) {
                            ...
                            arg_list = node.value_array;
                            mx_hash_stub = node.mx_hash = {};
                            mx_hash_stub.rule = "rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hblock_ultEfn_decl_eolE1__u136";
                            mx_hash_stub.hash_key = "stmt";
                            mx_hash_stub.hash_key_idx = 25;
                            mx_hash_stub["ult"] = "fn_decl";
                            mx_hash_stub["eol"] = 1;
          ...
          case 172:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hrvalue_ultEfn_decl__u137 queue */
          ...
          case 173:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hrvalue_ultEfn_decl__u137 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                      ...
                      for (_mr = 0, _len218 = list_6.length; _mr < _len218; _mr++) {
                        ...
                        for (_ms = 0, _len219 = list_7.length; _ms < _len219; _ms++) {
                          ...
                          for (_mt = 0, _len220 = list_8.length; _mt < _len220; _mt++) {
                            ...
                            arg_list = node.value_array;
                            mx_hash_stub = node.mx_hash = {};
                            mx_hash_stub.rule = "rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX_XXX_Htype_XXXX_Hrvalue_ultEfn_decl__u137";
                            mx_hash_stub.hash_key = "stmt";
                            mx_hash_stub.hash_key_idx = 25;
                            mx_hash_stub["ult"] = "fn_decl";
                            node.b = node.value_array.last().b;
          ...
          case 174:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_ultEfn_decl__u138 queue */
          ...
          case 175:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_ultEfn_decl__u138 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_nf = 0, _len226 = hyp_list_3.length; _nf < _len226; _nf++) {
                  ...
                  for (_ng = 0, _len227 = list_4.length; _ng < _len227; _ng++) {
                    ...
                    for (_nh = 0, _len228 = list_5.length; _nh < _len228; _nh++) {
                      ...
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_ultEfn_decl__u138";
                      mx_hash_stub.hash_key = "stmt";
                      mx_hash_stub.hash_key_idx = 25;
                      mx_hash_stub["ult"] = "fn_decl";
                      node.b = node.value_array.last().b;
          ...
          case 176:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hblock_ultEfn_decl_eolE1__u139 queue */
          ...
          case 177:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hblock_ultEfn_decl_eolE1__u139 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                  ...
                  for (_nw = 0, _len237 = list_4.length; _nw < _len237; _nw++) {
                    ...
                    for (_nx = 0, _len238 = list_5.length; _nx < _len238; _nx++) {
                      ...
                      for (_ny = 0, _len239 = list_6.length; _ny < _len239; _ny++) {
                        ...
                        arg_list = node.value_array;
                        mx_hash_stub = node.mx_hash = {};
                        mx_hash_stub.rule = "rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hblock_ultEfn_decl_eolE1__u139";
                        mx_hash_stub.hash_key = "stmt";
                        mx_hash_stub.hash_key_idx = 25;
                        mx_hash_stub["ult"] = "fn_decl";
                        mx_hash_stub["eol"] = 1;
          ...
          case 178:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hrvalue_ultEfn_decl__u140 queue */
          ...
          case 179:
            ...
            /* rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hrvalue_ultEfn_decl__u140 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                  ...
                  for (_on = 0, _len248 = list_4.length; _on < _len248; _on++) {
                    ...
                    for (_oo = 0, _len249 = list_5.length; _oo < _len249; _oo++) {
                      ...
                      for (_op = 0, _len250 = list_6.length; _op < _len250; _op++) {
                        ...
                        arg_list = node.value_array;
                        mx_hash_stub = node.mx_hash = {};
                        mx_hash_stub.rule = "rule_Htok_identifier_XXX_Hfn_decl_arg_listO_XXX__XXXX_Hrvalue_ultEfn_decl__u140";
                        mx_hash_stub.hash_key = "stmt";
                        mx_hash_stub.hash_key_idx = 25;
                        mx_hash_stub["ult"] = "fn_decl";
                        node.b = node.value_array.last().b;
          ...
          case 180:
            ...
            /* rule_class_Htok_identifier_ultEclass_decl__u147 queue */
          ...
          case 181:
            ...
            /* rule_class_Htok_identifier_ultEclass_decl__u147 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _or = _ref172 = FAcounter[b_0][305], _ref173 = list_1.length; _or < _ref173; idx_1 = _or += 1) {
              ...
              for (_os = 0, _len251 = list_2.length; _os < _len251; _os++) {
                ...
                arg_list = node.value_array;
                mx_hash_stub = node.mx_hash = {};
                mx_hash_stub.rule = "rule_class_Htok_identifier_ultEclass_decl__u147";
                mx_hash_stub.hash_key = "stmt";
                mx_hash_stub.hash_key_idx = 25;
          ...
          case 182:
            ...
            /* rule_class_Htok_identifier_Hblock_ultEclass_decl_eolE1__u148 queue */
          ...
          case 183:
            ...
            /* rule_class_Htok_identifier_Hblock_ultEclass_decl_eolE1__u148 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _ov = _ref176 = FAcounter[b_0][310], _ref177 = list_1.length; _ov < _ref177; idx_1 = _ov += 1) {
              ...
              for (_ow = 0, _len253 = list_2.length; _ow < _len253; _ow++) {
                ...
                for (_ox = 0, _len254 = list_3.length; _ox < _len254; _ox++) {
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_class_Htok_identifier_Hblock_ultEclass_decl_eolE1__u148";
                  mx_hash_stub.hash_key = "stmt";
                  mx_hash_stub.hash_key_idx = 25;
                  mx_hash_stub["ult"] = "class_decl";
                  mx_hash_stub["eol"] = 1;
          ...
          case 184:
            ...
            /* rule_Hlvalue_Hblock_ultEdirective_fn_call_tiEmacro_eolE1__u153 queue */
          ...
          case 185:
            ...
            /* rule_Hlvalue_Hblock_ultEdirective_fn_call_tiEmacro_eolE1__u153 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _oz = _ref180 = FAcounter[b_0][313], _ref181 = list_1.length; _oz < _ref181; idx_1 = _oz += 1) {
              ...
              for (_pa = 0, _len255 = list_2.length; _pa < _len255; _pa++) {
                ...
                arg_list = node.value_array;
                mx_hash_stub = node.mx_hash = {};
                mx_hash_stub.rule = "rule_Hlvalue_Hblock_ultEdirective_fn_call_tiEmacro_eolE1__u153";
                mx_hash_stub.hash_key = "stmt";
                mx_hash_stub.hash_key_idx = 25;
          ...
          case 186:
            ...
            /* rule_Hlvalue_Hfn_call_arg_list_Hblock_ultEdirective_fn_call_tiEmacro_eolE1_XXX1Xtail_space_u154 queue */
          ...
          case 187:
            ...
            /* rule_Hlvalue_Hfn_call_arg_list_Hblock_ultEdirective_fn_call_tiEmacro_eolE1_XXX1Xtail_space_u154 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _pd = _ref184 = FAcounter[b_0][318], _ref185 = list_1.length; _pd < _ref185; idx_1 = _pd += 1) {
              ...
              for (_pe = 0, _len257 = list_2.length; _pe < _len257; _pe++) {
                ...
                for (_pf = 0, _len258 = list_3.length; _pf < _len258; _pf++) {
                  ...
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hlvalue_Hfn_call_arg_list_Hblock_ultEdirective_fn_call_tiEmacro_eolE1_XXX1Xtail_space_u154";
                  mx_hash_stub.hash_key = "stmt";
                  mx_hash_stub.hash_key_idx = 25;
                  mx_hash_stub["ult"] = "directive_fn_call";
                  mx_hash_stub["ti"] = "macro";
          ...
          case 188:
            ...
            /* rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_eolE1_XX1Xtail_space_u155 queue */
          ...
          case 189:
            ...
            /* rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_eolE1_XX1Xtail_space_u155 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
                ...
                for (_ps = 0, _len265 = hyp_list_3.length; _ps < _len265; _ps++) {
                  ...
                  for (_pt = 0, _len266 = list_4.length; _pt < _len266; _pt++) {
                    ...
                    for (_pu = 0, _len267 = list_5.length; _pu < _len267; _pu++) {
                      ...
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_Hlvalue_XXX_Hfn_call_arg_listO_XXX_Hblock_priorityEX9000_ultEdirective_fn_call_eolE1_XX1Xtail_space_u155";
                      mx_hash_stub.hash_key = "stmt";
                      mx_hash_stub.hash_key_idx = 25;
                      mx_hash_stub["priority"] = -9000;
                      mx_hash_stub["ult"] = "directive_fn_call";
          ...
          case 214:
            ...
            /* rule_Htok_identifier_Htype_nestO_Htype_fieldO_ultEtype_name_tiEpass__u164 queue */
          ...
          case 215:
            ...
            /* rule_Htok_identifier_Htype_nestO_Htype_fieldO_ultEtype_name_tiEpass__u164 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            for (idx_1 = _rb = _ref216 = FAcounter[b_0][356], _ref217 = list_1.length; _rb < _ref217; idx_1 = _rb += 1) {
              ...
              for (_rf = 0, _len284 = hyp_list_2.length; _rf < _len284; _rf++) {
                ...
                for (_rj = 0, _len286 = hyp_list_3.length; _rj < _len286; _rj++) {
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Htok_identifier_Htype_nestO_Htype_fieldO_ultEtype_name_tiEpass__u164";
          ...
          case 223:
            ...
            /* rule_Hreturn_XXX_Hrvalue_eolEHrvalueXeol__u107 queue */
            ...
            list_1 = FAcache[b_0][39];
            for (idx_1 = _rz = _ref230 = FAcounter[b_0][373], _ref231 = list_1.length; _rz < _ref231; idx_1 = _rz += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_sa = 0, _len296 = list_2.length; _sa < _len296; _sa++) {
                tok = list_2[_sa];
                if (tok.value !== ":") {
                  continue;
                }
          ...
          case 224:
            ...
            /* rule_Hreturn_XXX_Hrvalue_eolEHrvalueXeol__u107 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][39];
            for (idx_1 = _sb = _ref232 = FAcounter[b_0][376], _ref233 = list_1.length; _sb < _ref233; idx_1 = _sb += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_sc = 0, _len297 = list_2.length; _sc < _len297; _sc++) {
                tok = list_2[_sc];
                if (tok.value !== ":") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][24];
                for (_sd = 0, _len298 = list_3.length; _sd < _len298; _sd++) {
                  tok = list_3[_sd];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hreturn_XXX_Hrvalue_eolEHrvalueXeol__u107";
                  mx_hash_stub.hash_key = "struct_init_kv";
                  mx_hash_stub.hash_key_idx = 36;
                  mx_hash_stub["eol"] = arg_list[2].mx_hash.eol;
                  node.b = node.value_array.last().b;
          ...
          case 225:
            ...
            /* rule_H__XXX_Hrvalue_eolEHrvalueXeol_X1Xremap_u108 queue */
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _se = _ref234 = FAcounter[b_0][378], _ref235 = list_1.length; _se < _ref235; idx_1 = _se += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
          ...
          case 226:
            ...
            /* rule_H__XXX_Hrvalue_eolEHrvalueXeol_X1Xremap_u108 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _sg = _ref236 = FAcounter[b_0][381], _ref237 = list_1.length; _sg < _ref237; idx_1 = _sg += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              for (_sh = 0, _len300 = list_2.length; _sh < _len300; _sh++) {
                ...
                list_3 = FAcache[b_2][24];
                for (_si = 0, _len301 = list_3.length; _si < _len301; _si++) {
                  tok = list_3[_si];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  if (!arg_list[0].mx_hash.remap) {
                    node.value_array.pop();
                    continue;
                  }
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_H__XXX_Hrvalue_eolEHrvalueXeol_X1Xremap_u108";
                  mx_hash_stub.hash_key = "struct_init_kv";
                  mx_hash_stub.hash_key_idx = 36;
                  mx_hash_stub["eol"] = arg_list[2].mx_hash.eol;
                  node.b = node.value_array.last().b;
          ...
          case 229:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][36];
            for (idx_1 = _sj = _ref238 = FAcounter[b_0][382], _ref239 = list_1.length; _sj < _ref239; idx_1 = _sj += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
            ...
            FAcounter[b_0][382] = list_1.length;
          ...
          case 230:
            ...
            list_1 = FAcache[b_0][36];
            for (idx_1 = _sk = _ref240 = FAcounter[b_0][383], _ref241 = list_1.length; _sk < _ref241; idx_1 = _sk += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
          ...
          case 231:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][36];
            for (idx_1 = _sl = _ref242 = FAcounter[b_0][385], _ref243 = list_1.length; _sl < _ref243; idx_1 = _sl += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][37];
              for (_sm = 0, _len302 = list_2.length; _sm < _len302; _sm++) {
                tok = list_2[_sm];
                b_2 = tok.b;
                node.value_array.push(tok);
                arg_list = node.value_array;
          ...
          case 232:
            ...
            list_1 = FAcache[b_0][36];
            for (idx_1 = _sn = _ref244 = FAcounter[b_0][387], _ref245 = list_1.length; _sn < _ref245; idx_1 = _sn += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
          ...
          case 233:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][36];
            for (idx_1 = _sp = _ref246 = FAcounter[b_0][390], _ref247 = list_1.length; _sp < _ref247; idx_1 = _sp += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][34];
              for (_sq = 0, _len304 = list_2.length; _sq < _len304; _sq++) {
                tok = list_2[_sq];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][37];
                for (_sr = 0, _len305 = list_3.length; _sr < _len305; _sr++) {
                  tok = list_3[_sr];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
          ...
          case 234:
            ...
            list_1 = FAcache[b_0][36];
            for (idx_1 = _ss = _ref248 = FAcounter[b_0][392], _ref249 = list_1.length; _ss < _ref249; idx_1 = _ss += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_st = 0, _len306 = list_2.length; _st < _len306; _st++) {
                tok = list_2[_st];
                if (tok.value !== ",") {
                  continue;
                }
          ...
          case 235:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][36];
            for (idx_1 = _su = _ref250 = FAcounter[b_0][395], _ref251 = list_1.length; _su < _ref251; idx_1 = _su += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_sv = 0, _len307 = list_2.length; _sv < _len307; _sv++) {
                tok = list_2[_sv];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][37];
                for (_sw = 0, _len308 = list_3.length; _sw < _len308; _sw++) {
                  tok = list_3[_sw];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
          ...
          case 236:
            ...
            list_1 = FAcache[b_0][36];
            for (idx_1 = _sx = _ref252 = FAcounter[b_0][398], _ref253 = list_1.length; _sx < _ref253; idx_1 = _sx += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_sy = 0, _len309 = list_2.length; _sy < _len309; _sy++) {
                tok = list_2[_sy];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                for (_sz = 0, _len310 = list_3.length; _sz < _len310; _sz++) {
                  tok = list_3[_sz];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  if (b_3 >= length) {
          ...
          case 237:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][36];
            for (idx_1 = _ta = _ref254 = FAcounter[b_0][402], _ref255 = list_1.length; _ta < _ref255; idx_1 = _ta += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_tb = 0, _len311 = list_2.length; _tb < _len311; _tb++) {
                tok = list_2[_tb];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][34];
                for (_tc = 0, _len312 = list_3.length; _tc < _len312; _tc++) {
                  tok = list_3[_tc];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  if (b_3 >= length) {
                  ...
                  list_4 = FAcache[b_3][37];
                  for (_td = 0, _len313 = list_4.length; _td < _len313; _td++) {
                    tok = list_4[_td];
                    b_4 = tok.b;
                    node.value_array.push(tok);
                    arg_list = node.value_array;
            ...
            FAcounter[b_0][402] = list_1.length;
            FAcache[start_pos][236].append(ret_list);
            break;
          case 239:
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _te = _ref256 = FAcounter[b_0][404], _ref257 = list_1.length; _te < _ref257; idx_1 = _te += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "{") {
                continue;
              }
              ...
              old_node = node;
              node = this.proxy;
              for (_i_2 = _tf = 0; _tf < 1; _i_2 = ++_tf) {

                /* NOPE */
                hyp_list_2.push(node.value_array.clone());
              }
              for (_i_2 = _tg = 0; _tg < 1; _i_2 = ++_tg) {
                if (b_1 >= length) {
                  node.value_array.pop();
                  continue;
                }
                ...
                list_2 = FAcache[b_1][37];
                for (_th = 0, _len314 = list_2.length; _th < _len314; _th++) {
                  tok = list_2[_th];
                  b_2 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_2.push(node.value_array.clone());
              ...
              node = old_node;
              for (_ti = 0, _len315 = hyp_list_2.length; _ti < _len315; _ti++) {
                tok_list = hyp_list_2[_ti];
                node.value_array.append(tok_list);
                b_2 = node.value_array.last().b;
                node.value_array.length -= tok_list.length;
              }
          ...
          case 240:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _tj = _ref258 = FAcounter[b_0][407], _ref259 = list_1.length; _tj < _ref259; idx_1 = _tj += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "{") {
                continue;
              }
              ...
              old_node = node;
              node = this.proxy;
              for (_i_2 = _tk = 0; _tk < 1; _i_2 = ++_tk) {

                /* NOPE */
                hyp_list_2.push(node.value_array.clone());
              }
              for (_i_2 = _tl = 0; _tl < 1; _i_2 = ++_tl) {
                if (b_1 >= length) {
                  node.value_array.pop();
                  continue;
                }
              ...
              node = old_node;
              for (_tn = 0, _len317 = hyp_list_2.length; _tn < _len317; _tn++) {
                tok_list = hyp_list_2[_tn];
                node.value_array.append(tok_list);
                b_2 = node.value_array.last().b;
                if (b_2 >= length) {
                  node.value_array.pop();
                ...
                list_3 = FAcache[b_2][0];
                for (_to = 0, _len318 = list_3.length; _to < _len318; _to++) {
                  tok = list_3[_to];
                  if (tok.value !== "}") {
                    continue;
                  }
            ...
            FAcounter[b_0][407] = list_1.length;
          ...
          case 241:
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _tp = _ref260 = FAcounter[b_0][410], _ref261 = list_1.length; _tp < _ref261; idx_1 = _tp += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "{") {
                continue;
              }
              ...
              for (_tq = 0, _len319 = list_2.length; _tq < _len319; _tq++) {
                tok = list_2[_tq];
                b_2 = tok.b;
                node.value_array.push(tok);
                hyp_list_3 = [];
                ...
                for (_i_3 = _ts = 0; _ts < 1; _i_3 = ++_ts) {
                  ...
                  list_3 = FAcache[b_2][37];
                  for (_tt = 0, _len320 = list_3.length; _tt < _len320; _tt++) {
                    tok = list_3[_tt];
                    b_3 = tok.b;
                    node.value_array.push(tok);
                    hyp_list_3.push(node.value_array.clone());
                ...
                node = old_node;
                for (_tu = 0, _len321 = hyp_list_3.length; _tu < _len321; _tu++) {
                  tok_list = hyp_list_3[_tu];
                  node.value_array.append(tok_list);
                  b_3 = node.value_array.last().b;
                  if (b_3 >= length) {
                    node.value_array.pop();
          ...
          case 242:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _tv = _ref262 = FAcounter[b_0][415], _ref263 = list_1.length; _tv < _ref263; idx_1 = _tv += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "{") {
                continue;
              }
              ...
              for (_tw = 0, _len322 = list_2.length; _tw < _len322; _tw++) {
                ...
                old_node = node;
                node = this.proxy;
                for (_i_3 = _tx = 0; _tx < 1; _i_3 = ++_tx) {

                  /* NOPE */
                  hyp_list_3.push(node.value_array.clone());
                }
                for (_i_3 = _ty = 0; _ty < 1; _i_3 = ++_ty) {
                  if (b_2 >= length) {
                    node.value_array.pop();
                    continue;
                  }
                  list_3 = FAcache[b_2][37];
                  for (_tz = 0, _len323 = list_3.length; _tz < _len323; _tz++) {
                    tok = list_3[_tz];
                    b_3 = tok.b;
                    node.value_array.push(tok);
                    hyp_list_3.push(node.value_array.clone());
                ...
                node = old_node;
                for (_ua = 0, _len324 = hyp_list_3.length; _ua < _len324; _ua++) {
                  tok_list = hyp_list_3[_ua];
                  node.value_array.append(tok_list);
                  b_3 = node.value_array.last().b;
                  if (b_3 >= length) {
                    node.value_array.pop();
                  ...
                  list_4 = FAcache[b_3][30];
                  for (_ub = 0, _len325 = list_4.length; _ub < _len325; _ub++) {
                    tok = list_4[_ub];
                    b_4 = tok.b;
                    node.value_array.push(tok);
                    if (b_4 >= length) {
                    ...
                    list_5 = FAcache[b_4][0];
                    for (_uc = 0, _len326 = list_5.length; _uc < _len326; _uc++) {
                      tok = list_5[_uc];
                      if (tok.value !== "}") {
                        continue;
                      }
          ...
          case 243:
            ...
            list_1 = FAcache[b_0][28];
            for (idx_1 = _ud = _ref264 = FAcounter[b_0][417], _ref265 = list_1.length; _ud < _ref265; idx_1 = _ud += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
          ...
          case 244:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][28];
            for (idx_1 = _uf = _ref266 = FAcounter[b_0][420], _ref267 = list_1.length; _uf < _ref267; idx_1 = _uf += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
          ...
          case 246:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][37];
            for (idx_1 = _ui = _ref268 = FAcounter[b_0][421], _ref269 = list_1.length; _ui < _ref269; idx_1 = _ui += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
          ...
          case 250:
            ...
            node.a = start_pos;
            list_1 = FAcache[b_0][24];
            for (idx_1 = _uj = _ref270 = FAcounter[b_0][422], _ref271 = list_1.length; _uj < _ref271; idx_1 = _uj += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Hrvalue___u109";
          ...
          case 251:
            ...
            /* rule_Hrvalue_Heol_____Harray_init_list___u110 queue */
            ...
            list_1 = FAcache[b_0][24];
            for (idx_1 = _uk = _ref272 = FAcounter[b_0][424], _ref273 = list_1.length; _uk < _ref273; idx_1 = _uk += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              for (_ul = 0, _len330 = list_2.length; _ul < _len330; _ul++) {
                ...
                state_3 = FAstate[b_2][40];
                if (state_3 !== STATE_FL) {
                  if (request_make(40, b_2, 0)) {
                    continue;
                  }
                }
                list_3 = FAcache[b_2][40];
                node.value_array.pop();
              }
              node.value_array.pop();
            }
          ...
          case 252:
            ...
            /* rule_Hrvalue_Heol_____Harray_init_list___u110 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][24];
            for (idx_1 = _um = _ref274 = FAcounter[b_0][427], _ref275 = list_1.length; _um < _ref275; idx_1 = _um += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][34];
              for (_un = 0, _len331 = list_2.length; _un < _len331; _un++) {
                tok = list_2[_un];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][40];
                for (_uo = 0, _len332 = list_3.length; _uo < _len332; _uo++) {
                  tok = list_3[_uo];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hrvalue_Heol_____Harray_init_list___u110";
                  mx_hash_stub.hash_key = "array_init_list";
                  mx_hash_stub.hash_key_idx = 40;
                  node.b = node.value_array.last().b;
                  ret_list.push(node.clone());
            ...
            FAcounter[b_0][427] = list_1.length;
            FAcache[start_pos][251].append(ret_list);
            break;
          case 253:

            /* rule_Hrvalue_XXX______Harray_init_list___u111 queue */
            ...
            list_1 = FAcache[b_0][24];
            for (idx_1 = _up = _ref276 = FAcounter[b_0][429], _ref277 = list_1.length; _up < _ref277; idx_1 = _up += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_uq = 0, _len333 = list_2.length; _uq < _len333; _uq++) {
                tok = list_2[_uq];
                if (tok.value !== ",") {
                  continue;
                }
          ...
          case 254:
            ...
            /* rule_Hrvalue_XXX______Harray_init_list___u111 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][24];
            for (idx_1 = _ur = _ref278 = FAcounter[b_0][432], _ref279 = list_1.length; _ur < _ref279; idx_1 = _ur += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_us = 0, _len334 = list_2.length; _us < _len334; _us++) {
                tok = list_2[_us];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][40];
                for (_ut = 0, _len335 = list_3.length; _ut < _len335; _ut++) {
                  tok = list_3[_ut];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hrvalue_XXX______Harray_init_list___u111";
                  mx_hash_stub.hash_key = "array_init_list";
                  mx_hash_stub.hash_key_idx = 40;
                  node.b = node.value_array.last().b;
                  ret_list.push(node.clone());
          ...
          case 255:
            ...
            /* rule_Hrvalue_XXX_Heol_Harray_init_list___u112 queue */
            ...
            list_1 = FAcache[b_0][24];
            for (idx_1 = _uu = _ref280 = FAcounter[b_0][435], _ref281 = list_1.length; _uu < _ref281; idx_1 = _uu += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_uv = 0, _len336 = list_2.length; _uv < _len336; _uv++) {
                tok = list_2[_uv];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][34];
                for (_uw = 0, _len337 = list_3.length; _uw < _len337; _uw++) {
                  tok = list_3[_uw];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  if (b_3 >= length) {
          ...
          case 256:
            ...
            /* rule_Hrvalue_XXX_Heol_Harray_init_list___u112 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][24];
            for (idx_1 = _ux = _ref282 = FAcounter[b_0][439], _ref283 = list_1.length; _ux < _ref283; idx_1 = _ux += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_uy = 0, _len338 = list_2.length; _uy < _len338; _uy++) {
                tok = list_2[_uy];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][34];
                for (_uz = 0, _len339 = list_3.length; _uz < _len339; _uz++) {
                  tok = list_3[_uz];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  if (b_3 >= length) {
                  ...
                  list_4 = FAcache[b_3][40];
                  for (_va = 0, _len340 = list_4.length; _va < _len340; _va++) {
                    tok = list_4[_va];
                    b_4 = tok.b;
                    node.value_array.push(tok);
                    arg_list = node.value_array;
                    mx_hash_stub = node.mx_hash = {};
                    mx_hash_stub.rule = "rule_Hrvalue_XXX_Heol_Harray_init_list___u112";
                    mx_hash_stub.hash_key = "array_init_list";
                    mx_hash_stub.hash_key_idx = 40;
                    node.b = node.value_array.last().b;
                    ret_list.push(node.clone());
            ...
            FAcounter[b_0][439] = list_1.length;
            FAcache[start_pos][255].append(ret_list);
            break;
          case 258:

            /* rule_XXX_Harray_init_listO_XXX___u113 queue */
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _vb = _ref284 = FAcounter[b_0][441], _ref285 = list_1.length; _vb < _ref285; idx_1 = _vb += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "[") {
                continue;
              }
              ...
              old_node = node;
              node = this.proxy;
              for (_i_2 = _vc = 0; _vc < 1; _i_2 = ++_vc) {

                /* NOPE */
                hyp_list_2.push(node.value_array.clone());
              }
              for (_i_2 = _vd = 0; _vd < 1; _i_2 = ++_vd) {
                if (b_1 >= length) {
                  node.value_array.pop();
                  continue;
                }
                state_2 = FAstate[b_1][40];
                if (state_2 !== STATE_FL) {
                  if (request_make(40, b_1, 0)) {
                    continue;
                  }
                }
                list_2 = FAcache[b_1][40];
                for (_ve = 0, _len341 = list_2.length; _ve < _len341; _ve++) {
                  tok = list_2[_ve];
                  b_2 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_2.push(node.value_array.clone());
              ...
              node = old_node;
              for (_vf = 0, _len342 = hyp_list_2.length; _vf < _len342; _vf++) {
                tok_list = hyp_list_2[_vf];
                node.value_array.append(tok_list);
                b_2 = node.value_array.last().b;
                node.value_array.length -= tok_list.length;
              }
          ...
          case 259:
            ...
            /* rule_XXX_Harray_init_listO_XXX___u113 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _vg = _ref286 = FAcounter[b_0][444], _ref287 = list_1.length; _vg < _ref287; idx_1 = _vg += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "[") {
                continue;
              }
              ...
              old_node = node;
              node = this.proxy;
              for (_i_2 = _vh = 0; _vh < 1; _i_2 = ++_vh) {

                /* NOPE */
                hyp_list_2.push(node.value_array.clone());
              }
              for (_i_2 = _vi = 0; _vi < 1; _i_2 = ++_vi) {
                if (b_1 >= length) {
                  node.value_array.pop();
                  continue;
                }
              ...
              node = old_node;
              for (_vk = 0, _len344 = hyp_list_2.length; _vk < _len344; _vk++) {
                tok_list = hyp_list_2[_vk];
                node.value_array.append(tok_list);
                b_2 = node.value_array.last().b;
                if (b_2 >= length) {
                  node.value_array.pop();
                ...
                list_3 = FAcache[b_2][0];
                for (_vl = 0, _len345 = list_3.length; _vl < _len345; _vl++) {
                  tok = list_3[_vl];
                  if (tok.value !== "]") {
                    continue;
                  }
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_XXX_Harray_init_listO_XXX___u113";
            ...
            FAcounter[b_0][444] = list_1.length;
            FAcache[start_pos][258].append(ret_list);
            break;
          case 260:

            /* rule_XXX_Hindent_Harray_init_listO_Hdedent_XXX___u114 queue */
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _vm = _ref288 = FAcounter[b_0][447], _ref289 = list_1.length; _vm < _ref289; idx_1 = _vm += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "[") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][28];
              for (_vn = 0, _len346 = list_2.length; _vn < _len346; _vn++) {
                tok = list_2[_vn];
                b_2 = tok.b;
                node.value_array.push(tok);
                hyp_list_3 = [];
                ...
                for (_i_3 = _vp = 0; _vp < 1; _i_3 = ++_vp) {
                  ...
                  list_3 = FAcache[b_2][40];
                  for (_vq = 0, _len347 = list_3.length; _vq < _len347; _vq++) {
                    tok = list_3[_vq];
                    b_3 = tok.b;
                    node.value_array.push(tok);
                    hyp_list_3.push(node.value_array.clone());
                ...
                node = old_node;
                for (_vr = 0, _len348 = hyp_list_3.length; _vr < _len348; _vr++) {
                  tok_list = hyp_list_3[_vr];
                  node.value_array.append(tok_list);
                  b_3 = node.value_array.last().b;
                  if (b_3 >= length) {
                    node.value_array.pop();
          ...
          case 261:
            ...
            /* rule_XXX_Hindent_Harray_init_listO_Hdedent_XXX___u114 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _vs = _ref290 = FAcounter[b_0][452], _ref291 = list_1.length; _vs < _ref291; idx_1 = _vs += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "[") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][28];
              for (_vt = 0, _len349 = list_2.length; _vt < _len349; _vt++) {
                tok = list_2[_vt];
                b_2 = tok.b;
                node.value_array.push(tok);
                hyp_list_3 = [];
                old_node = node;
                node = this.proxy;
                for (_i_3 = _vu = 0; _vu < 1; _i_3 = ++_vu) {

                  /* NOPE */
                  hyp_list_3.push(node.value_array.clone());
                }
                for (_i_3 = _vv = 0; _vv < 1; _i_3 = ++_vv) {
                  if (b_2 >= length) {
                    node.value_array.pop();
                    continue;
                  }
                  list_3 = FAcache[b_2][40];
                  for (_vw = 0, _len350 = list_3.length; _vw < _len350; _vw++) {
                    tok = list_3[_vw];
                    b_3 = tok.b;
                    node.value_array.push(tok);
                    hyp_list_3.push(node.value_array.clone());
                ...
                node = old_node;
                for (_vx = 0, _len351 = hyp_list_3.length; _vx < _len351; _vx++) {
                  tok_list = hyp_list_3[_vx];
                  node.value_array.append(tok_list);
                  b_3 = node.value_array.last().b;
                  if (b_3 >= length) {
                    node.value_array.pop();
                  ...
                  list_4 = FAcache[b_3][30];
                  for (_vy = 0, _len352 = list_4.length; _vy < _len352; _vy++) {
                    tok = list_4[_vy];
                    b_4 = tok.b;
                    node.value_array.push(tok);
                    if (b_4 >= length) {
                    ...
                    list_5 = FAcache[b_4][0];
                    for (_vz = 0, _len353 = list_5.length; _vz < _len353; _vz++) {
                      tok = list_5[_vz];
                      if (tok.value !== "]") {
                        continue;
                      }
                      ...
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_XXX_Hindent_Harray_init_listO_Hdedent_XXX___u114";
                      mx_hash_stub.hash_key = "array_init";
                      mx_hash_stub.hash_key_idx = 41;
                      node.b = node.value_array.last().b;
                      ret_list.push(node.clone());
          ...
          case 263:
            ...
            /* rule_else_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u117 queue */
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _wa = _ref292 = FAcounter[b_0][457], _ref293 = list_1.length; _wa < _ref293; idx_1 = _wa += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "else") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][0];
              for (_wb = 0, _len354 = list_2.length; _wb < _len354; _wb++) {
                tok = list_2[_wb];
                if (tok.value !== "if") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][24];
                for (_wc = 0, _len355 = list_3.length; _wc < _len355; _wc++) {
                  tok = list_3[_wc];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  if (b_3 >= length) {
                  ...
                  for (_wd = 0, _len356 = list_4.length; _wd < _len356; _wd++) {
                    tok = list_4[_wd];
                    b_4 = tok.b;
                    node.value_array.push(tok);
                    hyp_list_5 = [];
                    ...
                    for (_i_5 = _wf = 0; _wf < 1; _i_5 = ++_wf) {
                      ...
                      state_5 = FAstate[b_4][42];
                      if (state_5 !== STATE_FL) {
                        if (request_make(42, b_4, 0)) {
                          continue;
                        }
                      }
                      list_5 = FAcache[b_4][42];
                      for (_wg = 0, _len357 = list_5.length; _wg < _len357; _wg++) {
                        tok = list_5[_wg];
                        b_5 = tok.b;
                        node.value_array.push(tok);
                        hyp_list_5.push(node.value_array.clone());
                    ...
                    node = old_node;
                    for (_wh = 0, _len358 = hyp_list_5.length; _wh < _len358; _wh++) {
                      tok_list = hyp_list_5[_wh];
                      node.value_array.append(tok_list);
          ...
          case 264:
            ...
            /* rule_else_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u117 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _wi = _ref294 = FAcounter[b_0][462], _ref295 = list_1.length; _wi < _ref295; idx_1 = _wi += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "else") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][0];
              for (_wj = 0, _len359 = list_2.length; _wj < _len359; _wj++) {
                tok = list_2[_wj];
                if (tok.value !== "if") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][24];
                for (_wk = 0, _len360 = list_3.length; _wk < _len360; _wk++) {
                  tok = list_3[_wk];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  if (b_3 >= length) {
                  ...
                  list_4 = FAcache[b_3][27];
                  for (_wl = 0, _len361 = list_4.length; _wl < _len361; _wl++) {
                    tok = list_4[_wl];
                    b_4 = tok.b;
                    node.value_array.push(tok);
                    hyp_list_5 = [];
                    old_node = node;
                    node = this.proxy;
                    for (_i_5 = _wm = 0; _wm < 1; _i_5 = ++_wm) {

                      /* NOPE */
                      hyp_list_5.push(node.value_array.clone());
                    }
                    for (_i_5 = _wn = 0; _wn < 1; _i_5 = ++_wn) {
                      if (b_4 >= length) {
                        node.value_array.pop();
                        continue;
                      }
                      list_5 = FAcache[b_4][42];
                      for (_wo = 0, _len362 = list_5.length; _wo < _len362; _wo++) {
                        tok = list_5[_wo];
                        b_5 = tok.b;
                        node.value_array.push(tok);
                        hyp_list_5.push(node.value_array.clone());
                    ...
                    node = old_node;
                    for (_wp = 0, _len363 = hyp_list_5.length; _wp < _len363; _wp++) {
                      tok_list = hyp_list_5[_wp];
                      node.value_array.append(tok_list);
                      b_5 = node.value_array.last().b;
                      arg_list = node.value_array;
                      mx_hash_stub = node.mx_hash = {};
                      mx_hash_stub.rule = "rule_else_if_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u117";
          ...
          case 265:
            ...
            /* rule_elseifXelsifXelif_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u118 queue */
            ...
            node = this.proxy;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _wq = _ref296 = FAcounter[b_0][466], _ref297 = list_1.length; _wq < _ref297; idx_1 = _wq += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "elseif") {
                continue;
              }
            ...
            list_1 = FAcache[b_0][0];
            for (idx_1 = _wr = _ref298 = FAcounter[b_0][467], _ref299 = list_1.length; _wr < _ref299; idx_1 = _wr += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "elsif") {
                continue;
              }
            ...
            list_1 = FAcache[b_0][0];
            for (idx_1 = _ws = _ref300 = FAcounter[b_0][468], _ref301 = list_1.length; _ws < _ref301; idx_1 = _ws += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "elif") {
                continue;
              }
            ...
            node = old_node;
            for (_wt = 0, _len364 = hyp_list_1.length; _wt < _len364; _wt++) {
              ...
              list_2 = FAcache[b_1][24];
              for (_wu = 0, _len365 = list_2.length; _wu < _len365; _wu++) {
                tok = list_2[_wu];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][27];
                for (_wv = 0, _len366 = list_3.length; _wv < _len366; _wv++) {
                  tok = list_3[_wv];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_4 = [];
                  ...
                  for (_i_4 = _wx = 0; _wx < 1; _i_4 = ++_wx) {
                    ...
                    list_4 = FAcache[b_3][42];
                    for (_wy = 0, _len367 = list_4.length; _wy < _len367; _wy++) {
                      tok = list_4[_wy];
                      b_4 = tok.b;
                      node.value_array.push(tok);
                      hyp_list_4.push(node.value_array.clone());
                  ...
                  node = old_node;
                  for (_wz = 0, _len368 = hyp_list_4.length; _wz < _len368; _wz++) {
          ...
          case 266:
            ...
            /* rule_elseifXelsifXelif_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u118 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            node = this.proxy;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xa = _ref302 = FAcounter[b_0][472], _ref303 = list_1.length; _xa < _ref303; idx_1 = _xa += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "elseif") {
                continue;
              }
            ...
            FAcounter[b_0][472] = list_1.length;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xb = _ref304 = FAcounter[b_0][473], _ref305 = list_1.length; _xb < _ref305; idx_1 = _xb += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "elsif") {
                continue;
              }
            ...
            FAcounter[b_0][473] = list_1.length;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xc = _ref306 = FAcounter[b_0][474], _ref307 = list_1.length; _xc < _ref307; idx_1 = _xc += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "elif") {
                continue;
              }
            ...
            node = old_node;
            for (_xd = 0, _len369 = hyp_list_1.length; _xd < _len369; _xd++) {
              tok_list = hyp_list_1[_xd];
              node.value_array.append(tok_list);
              if (b_1 >= length) {
                node.value_array.pop();
                continue;
              ...
              list_2 = FAcache[b_1][24];
              for (_xe = 0, _len370 = list_2.length; _xe < _len370; _xe++) {
                tok = list_2[_xe];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][27];
                for (_xf = 0, _len371 = list_3.length; _xf < _len371; _xf++) {
                  tok = list_3[_xf];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_4 = [];
                  ...
                  for (_i_4 = _xh = 0; _xh < 1; _i_4 = ++_xh) {
                    ...
                    list_4 = FAcache[b_3][42];
                    for (_xi = 0, _len372 = list_4.length; _xi < _len372; _xi++) {
                      tok = list_4[_xi];
                      b_4 = tok.b;
                      node.value_array.push(tok);
                      hyp_list_4.push(node.value_array.clone());
                  ...
                  node = old_node;
                  for (_xj = 0, _len373 = hyp_list_4.length; _xj < _len373; _xj++) {
                    tok_list = hyp_list_4[_xj];
                    node.value_array.append(tok_list);
                    b_4 = node.value_array.last().b;
                    arg_list = node.value_array;
                    mx_hash_stub = node.mx_hash = {};
                    mx_hash_stub.rule = "rule_elseifXelsifXelif_Hrvalue_Hblock_Hif_tail_stmtO_ultEelse_if_tiEelse_if_eolE1__u118";
                    mx_hash_stub.hash_key = "if_tail_stmt";
                    mx_hash_stub.hash_key_idx = 42;
                    mx_hash_stub["ult"] = "else_if";
                    mx_hash_stub["ti"] = "else_if";
          ...
          case 267:
            ...
            /* rule_else_Hblock_ultEelse_tiEelse_eolE1__u119 queue */
            ...
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xk = _ref308 = FAcounter[b_0][475], _ref309 = list_1.length; _xk < _ref309; idx_1 = _xk += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "else") {
                continue;
              }
          ...
          case 268:
            ...
            /* rule_else_Hblock_ultEelse_tiEelse_eolE1__u119 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xl = _ref310 = FAcounter[b_0][477], _ref311 = list_1.length; _xl < _ref311; idx_1 = _xl += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "else") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][27];
              for (_xm = 0, _len374 = list_2.length; _xm < _len374; _xm++) {
                tok = list_2[_xm];
                b_2 = tok.b;
                node.value_array.push(tok);
                arg_list = node.value_array;
                mx_hash_stub = node.mx_hash = {};
                mx_hash_stub.rule = "rule_else_Hblock_ultEelse_tiEelse_eolE1__u119";
                mx_hash_stub.hash_key = "if_tail_stmt";
                mx_hash_stub.hash_key_idx = 42;
            ...
            FAcounter[b_0][477] = list_1.length;
            FAcache[start_pos][267].append(ret_list);
            break;
          case 270:

            /* rule_when_Hrvalue_Hblock_Hswitch_tail_stmtO_ultEswitch_when_tiEswitch_when_eolE1__u122 queue */
            chk_len = stack.push([270, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xn = _ref312 = FAcounter[b_0][481], _ref313 = list_1.length; _xn < _ref313; idx_1 = _xn += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "when") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][24];
              for (_xo = 0, _len375 = list_2.length; _xo < _len375; _xo++) {
                tok = list_2[_xo];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][27];
                for (_xp = 0, _len376 = list_3.length; _xp < _len376; _xp++) {
                  tok = list_3[_xp];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_4 = [];
                  ...
                  for (_i_4 = _xr = 0; _xr < 1; _i_4 = ++_xr) {
                    ...
                    list_4 = FAcache[b_3][43];
                    for (_xs = 0, _len377 = list_4.length; _xs < _len377; _xs++) {
                      tok = list_4[_xs];
                      b_4 = tok.b;
                      node.value_array.push(tok);
                      hyp_list_4.push(node.value_array.clone());
                  ...
                  node = old_node;
                  for (_xt = 0, _len378 = hyp_list_4.length; _xt < _len378; _xt++) {
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 271;
            }
            break;
          case 271:

            /* rule_when_Hrvalue_Hblock_Hswitch_tail_stmtO_ultEswitch_when_tiEswitch_when_eolE1__u122 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _xu = _ref314 = FAcounter[b_0][485], _ref315 = list_1.length; _xu < _ref315; idx_1 = _xu += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "when") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][24];
              for (_xv = 0, _len379 = list_2.length; _xv < _len379; _xv++) {
                tok = list_2[_xv];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][27];
                for (_xw = 0, _len380 = list_3.length; _xw < _len380; _xw++) {
                  tok = list_3[_xw];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_4 = [];
                  old_node = node;
                  node = this.proxy;
                  for (_i_4 = _xx = 0; _xx < 1; _i_4 = ++_xx) {

                    /* NOPE */
                    hyp_list_4.push(node.value_array.clone());
                  }
                  for (_i_4 = _xy = 0; _xy < 1; _i_4 = ++_xy) {
                    if (b_3 >= length) {
                      node.value_array.pop();
                      continue;
                    }
                    list_4 = FAcache[b_3][43];
                    for (_xz = 0, _len381 = list_4.length; _xz < _len381; _xz++) {
                      tok = list_4[_xz];
                      b_4 = tok.b;
                      node.value_array.push(tok);
                      hyp_list_4.push(node.value_array.clone());
                  ...
                  node = old_node;
                  for (_ya = 0, _len382 = hyp_list_4.length; _ya < _len382; _ya++) {
                    tok_list = hyp_list_4[_ya];
                    node.value_array.append(tok_list);
                    b_4 = node.value_array.last().b;
                    arg_list = node.value_array;
                    mx_hash_stub = node.mx_hash = {};
                    mx_hash_stub.rule = "rule_when_Hrvalue_Hblock_Hswitch_tail_stmtO_ultEswitch_when_tiEswitch_when_eolE1__u122";
            ...
            FAcache[start_pos][270].append(ret_list);
            break;
          case 272:

            /* rule_else_Hblock_ultEswitch_else_tiEswitch_else_eolE1__u123 queue */
            chk_len = stack.push([272, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _yb = _ref316 = FAcounter[b_0][486], _ref317 = list_1.length; _yb < _ref317; idx_1 = _yb += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "else") {
                continue;
              }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 273;
            }
            break;
          case 273:

            /* rule_else_Hblock_ultEswitch_else_tiEswitch_else_eolE1__u123 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _yc = _ref318 = FAcounter[b_0][488], _ref319 = list_1.length; _yc < _ref319; idx_1 = _yc += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "else") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][27];
              for (_yd = 0, _len383 = list_2.length; _yd < _len383; _yd++) {
                tok = list_2[_yd];
                b_2 = tok.b;
                node.value_array.push(tok);
                arg_list = node.value_array;
                mx_hash_stub = node.mx_hash = {};
                mx_hash_stub.rule = "rule_else_Hblock_ultEswitch_else_tiEswitch_else_eolE1__u123";
                mx_hash_stub.hash_key = "switch_tail_stmt";
                mx_hash_stub.hash_key_idx = 43;
            ...
            FAcounter[b_0][488] = list_1.length;
            FAcache[start_pos][272].append(ret_list);
            break;
          case 276:

            /* rule_Htok_identifier_XXX_Htype___u130 queue */
            ...
            list_1 = FAcache[b_0][2];
            for (idx_1 = _ye = _ref320 = FAcounter[b_0][490], _ref321 = list_1.length; _ye < _ref321; idx_1 = _ye += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
          ...
          case 277:
            ...
            /* rule_Htok_identifier_XXX_Htype___u130 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][2];
            for (idx_1 = _yg = _ref322 = FAcounter[b_0][493], _ref323 = list_1.length; _yg < _ref323; idx_1 = _yg += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              for (_yh = 0, _len385 = list_2.length; _yh < _len385; _yh++) {
                ...
                for (_yi = 0, _len386 = list_3.length; _yi < _len386; _yi++) {
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Htok_identifier_XXX_Htype___u130";
            ...
            FAcounter[b_0][493] = list_1.length;
            FAcache[start_pos][276].append(ret_list);
            break;
          case 278:

            /* rule_Htok_identifier___u131 queue */
          ...
          case 279:
            ...
            /* rule_Htok_identifier___u131 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][2];
            for (idx_1 = _yj = _ref324 = FAcounter[b_0][494], _ref325 = list_1.length; _yj < _ref325; idx_1 = _yj += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Htok_identifier___u131";
              mx_hash_stub.hash_key = "fn_decl_arg";
              mx_hash_stub.hash_key_idx = 45;
              node.b = node.value_array.last().b;
              ret_list.push(node.clone());
            ...
            FAcounter[b_0][494] = list_1.length;
            FAcache[start_pos][278].append(ret_list);
            break;
          case 281:

            /* rule_Hfn_decl_arg___u132 queue */
            chk_len = stack.push([281, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            state_1 = FAstate[b_0][45];
            if (state_1 !== STATE_FL) {
              if (request_make(45, b_0, 0)) {
                continue;
              }
            }
            list_1 = FAcache[b_0][45];
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 282;
            }
            break;
          case 282:

            /* rule_Hfn_decl_arg___u132 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][45];
            for (idx_1 = _yk = _ref326 = FAcounter[b_0][495], _ref327 = list_1.length; _yk < _ref327; idx_1 = _yk += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Hfn_decl_arg___u132";
            ...
            FAcounter[b_0][495] = list_1.length;
            FAcache[start_pos][281].append(ret_list);
            break;
          case 283:

            /* rule_Hfn_decl_arg_XXX_Hfn_decl_arg_list___u133 queue */
            chk_len = stack.push([283, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            list_1 = FAcache[b_0][45];
            for (idx_1 = _yl = _ref328 = FAcounter[b_0][497], _ref329 = list_1.length; _yl < _ref329; idx_1 = _yl += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_ym = 0, _len387 = list_2.length; _ym < _len387; _ym++) {
                tok = list_2[_ym];
                if (tok.value !== ",") {
                  continue;
                }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 284;
            }
            break;
          case 284:

            /* rule_Hfn_decl_arg_XXX_Hfn_decl_arg_list___u133 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][45];
            for (idx_1 = _yn = _ref330 = FAcounter[b_0][500], _ref331 = list_1.length; _yn < _ref331; idx_1 = _yn += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_yo = 0, _len388 = list_2.length; _yo < _len388; _yo++) {
                tok = list_2[_yo];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][46];
                for (_yp = 0, _len389 = list_3.length; _yp < _len389; _yp++) {
                  tok = list_3[_yp];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hfn_decl_arg_XXX_Hfn_decl_arg_list___u133";
                  mx_hash_stub.hash_key = "fn_decl_arg_list";
                  mx_hash_stub.hash_key_idx = 46;
                  node.b = node.value_array.last().b;
                  ret_list.push(node.clone());
            ...
            FAcounter[b_0][500] = list_1.length;
            FAcache[start_pos][283].append(ret_list);
            break;
          case 286:

            /* rule_Hrvalue_bracketless_hashEX1Xbracketless_hash__u149 queue */
            chk_len = stack.push([286, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            list_1 = FAcache[b_0][24];
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 287;
            }
            break;
          case 287:

            /* rule_Hrvalue_bracketless_hashEX1Xbracketless_hash__u149 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][24];
            for (idx_1 = _yq = _ref332 = FAcounter[b_0][501], _ref333 = list_1.length; _yq < _ref333; idx_1 = _yq += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Hrvalue_bracketless_hashEX1Xbracketless_hash__u149";
            ...
            FAcounter[b_0][501] = list_1.length;
            FAcache[start_pos][286].append(ret_list);
            break;
          case 288:

            /* rule_Hrvalue_XXX_Hfn_call_arg_list_bracketless_hashEX1Xbracketless_hash_XX1Xbracketless_hashXXXX3Xbracketless_hash_u150 queue */
            chk_len = stack.push([288, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            list_1 = FAcache[b_0][24];
            for (idx_1 = _yr = _ref334 = FAcounter[b_0][503], _ref335 = list_1.length; _yr < _ref335; idx_1 = _yr += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_ys = 0, _len390 = list_2.length; _ys < _len390; _ys++) {
                tok = list_2[_ys];
                if (tok.value !== ",") {
                  continue;
                }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 289;
            }
            break;
          case 289:

            /* rule_Hrvalue_XXX_Hfn_call_arg_list_bracketless_hashEX1Xbracketless_hash_XX1Xbracketless_hashXXXX3Xbracketless_hash_u150 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][24];
            for (idx_1 = _yt = _ref336 = FAcounter[b_0][506], _ref337 = list_1.length; _yt < _ref337; idx_1 = _yt += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_yu = 0, _len391 = list_2.length; _yu < _len391; _yu++) {
                tok = list_2[_yu];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][47];
                for (_yv = 0, _len392 = list_3.length; _yv < _len392; _yv++) {
                  tok = list_3[_yv];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  ...
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Hrvalue_XXX_Hfn_call_arg_list_bracketless_hashEX1Xbracketless_hash_XX1Xbracketless_hashXXXX3Xbracketless_hash_u150";
                  mx_hash_stub.hash_key = "fn_call_arg_list";
                  mx_hash_stub.hash_key_idx = 47;
                  mx_hash_stub["bracketless_hash"] = arg_list[0].mx_hash.bracketless_hash;
                  node.b = node.value_array.last().b;
            ...
            FAcache[start_pos][288].append(ret_list);
            break;
          case 291:

            /* rule_Htype___u157 queue */
            chk_len = stack.push([291, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 292;
            }
            break;
          case 292:

            /* rule_Htype___u157 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][35];
            for (idx_1 = _yw = _ref338 = FAcounter[b_0][507], _ref339 = list_1.length; _yw < _ref339; idx_1 = _yw += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Htype___u157";
            ...
            FAcounter[b_0][507] = list_1.length;
            FAcache[start_pos][291].append(ret_list);
            break;
          case 293:

            /* rule_Htype_XXX_Htype_list___u158 queue */
            chk_len = stack.push([293, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            list_1 = FAcache[b_0][35];
            for (idx_1 = _yx = _ref340 = FAcounter[b_0][509], _ref341 = list_1.length; _yx < _ref341; idx_1 = _yx += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_yy = 0, _len393 = list_2.length; _yy < _len393; _yy++) {
                tok = list_2[_yy];
                if (tok.value !== ",") {
                  continue;
                }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 294;
            }
            break;
          case 294:

            /* rule_Htype_XXX_Htype_list___u158 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][35];
            for (idx_1 = _yz = _ref342 = FAcounter[b_0][512], _ref343 = list_1.length; _yz < _ref343; idx_1 = _yz += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_za = 0, _len394 = list_2.length; _za < _len394; _za++) {
                tok = list_2[_za];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][48];
                for (_zb = 0, _len395 = list_3.length; _zb < _len395; _zb++) {
                  tok = list_3[_zb];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Htype_XXX_Htype_list___u158";
                  mx_hash_stub.hash_key = "type_list";
                  mx_hash_stub.hash_key_idx = 48;
                  node.b = node.value_array.last().b;
                  ret_list.push(node.clone());
            ...
            FAcache[start_pos][293].append(ret_list);
            break;
          case 296:

            /* rule_XXX_Htype_list_XXX___u159 queue */
            chk_len = stack.push([296, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _zc = _ref344 = FAcounter[b_0][513], _ref345 = list_1.length; _zc < _ref345; idx_1 = _zc += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "<") {
                continue;
              }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 297;
            }
            break;
          case 297:

            /* rule_XXX_Htype_list_XXX___u159 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _zd = _ref346 = FAcounter[b_0][516], _ref347 = list_1.length; _zd < _ref347; idx_1 = _zd += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "<") {
                continue;
              }
              ...
              list_2 = FAcache[b_1][48];
              for (_ze = 0, _len396 = list_2.length; _ze < _len396; _ze++) {
                tok = list_2[_ze];
                b_2 = tok.b;
                node.value_array.push(tok);
                if (b_2 >= length) {
                ...
                list_3 = FAcache[b_2][0];
                for (_zf = 0, _len397 = list_3.length; _zf < _len397; _zf++) {
                  tok = list_3[_zf];
                  if (tok.value !== ">") {
                    continue;
                  }
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_XXX_Htype_list_XXX___u159";
            ...
            FAcounter[b_0][516] = list_1.length;
            FAcache[start_pos][296].append(ret_list);
            break;
          case 299:

            /* rule_Htok_identifier_XXX_Htype___u160 queue */
            chk_len = stack.push([299, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            list_1 = FAcache[b_0][2];
            for (idx_1 = _zg = _ref348 = FAcounter[b_0][518], _ref349 = list_1.length; _zg < _ref349; idx_1 = _zg += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_zh = 0, _len398 = list_2.length; _zh < _len398; _zh++) {
                tok = list_2[_zh];
                if (tok.value !== ":") {
                  continue;
                }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 300;
            }
            break;
          case 300:

            /* rule_Htok_identifier_XXX_Htype___u160 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][2];
            for (idx_1 = _zi = _ref350 = FAcounter[b_0][521], _ref351 = list_1.length; _zi < _ref351; idx_1 = _zi += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_zj = 0, _len399 = list_2.length; _zj < _len399; _zj++) {
                tok = list_2[_zj];
                if (tok.value !== ":") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][35];
                for (_zk = 0, _len400 = list_3.length; _zk < _len400; _zk++) {
                  tok = list_3[_zk];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Htok_identifier_XXX_Htype___u160";
            ...
            FAcounter[b_0][521] = list_1.length;
            FAcache[start_pos][299].append(ret_list);
            break;
          case 302:

            /* rule_Htype_field_kv___u161 queue */
            chk_len = stack.push([302, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 303;
            }
            break;
          case 303:

            /* rule_Htype_field_kv___u161 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][50];
            for (idx_1 = _zl = _ref352 = FAcounter[b_0][522], _ref353 = list_1.length; _zl < _ref353; idx_1 = _zl += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              arg_list = node.value_array;
              mx_hash_stub = node.mx_hash = {};
              mx_hash_stub.rule = "rule_Htype_field_kv___u161";
            ...
            FAcache[start_pos][302].append(ret_list);
            break;
          case 304:

            /* rule_Htype_field_kv_XXX_Htype_field_kv_list___u162 queue */
            chk_len = stack.push([304, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            ...
            list_1 = FAcache[b_0][50];
            for (idx_1 = _zm = _ref354 = FAcounter[b_0][524], _ref355 = list_1.length; _zm < _ref355; idx_1 = _zm += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 305;
            }
            break;
          case 305:

            /* rule_Htype_field_kv_XXX_Htype_field_kv_list___u162 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][50];
            for (idx_1 = _zo = _ref356 = FAcounter[b_0][527], _ref357 = list_1.length; _zo < _ref357; idx_1 = _zo += 1) {
              tok = list_1[idx_1];
              b_1 = tok.b;
              node.value_array.push(tok);
              if (b_1 >= length) {
              ...
              list_2 = FAcache[b_1][0];
              for (_zp = 0, _len402 = list_2.length; _zp < _len402; _zp++) {
                tok = list_2[_zp];
                if (tok.value !== ",") {
                  continue;
                }
                ...
                list_3 = FAcache[b_2][51];
                for (_zq = 0, _len403 = list_3.length; _zq < _len403; _zq++) {
                  tok = list_3[_zq];
                  b_3 = tok.b;
                  node.value_array.push(tok);
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_Htype_field_kv_XXX_Htype_field_kv_list___u162";
                  mx_hash_stub.hash_key = "type_field_kv_list";
                  mx_hash_stub.hash_key_idx = 51;
                  node.b = node.value_array.last().b;
                  ret_list.push(node.clone());
            ...
            FAcounter[b_0][527] = list_1.length;
            FAcache[start_pos][304].append(ret_list);
            break;
          case 307:

            /* rule_XXX_Htype_field_kv_listO_XXX___u163 queue */
            chk_len = stack.push([307, start_pos, only_new]);
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            list_1 = FAcache[b_0][0];
            for (idx_1 = _zr = _ref358 = FAcounter[b_0][529], _ref359 = list_1.length; _zr < _ref359; idx_1 = _zr += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "{") {
                continue;
              }
              ...
              old_node = node;
              node = this.proxy;
              for (_i_2 = _zs = 0; _zs < 1; _i_2 = ++_zs) {

                /* NOPE */
                hyp_list_2.push(node.value_array.clone());
              }
              for (_i_2 = _zt = 0; _zt < 1; _i_2 = ++_zt) {
                if (b_1 >= length) {
                  node.value_array.pop();
                  continue;
                }
                ...
                for (_zu = 0, _len404 = list_2.length; _zu < _len404; _zu++) {
                  tok = list_2[_zu];
                  b_2 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_2.push(node.value_array.clone());
              ...
              node = old_node;
              for (_zv = 0, _len405 = hyp_list_2.length; _zv < _len405; _zv++) {
                tok_list = hyp_list_2[_zv];
                node.value_array.append(tok_list);
                b_2 = node.value_array.last().b;
                node.value_array.length -= tok_list.length;
              }
            ...
            if (chk_len === stack.length) {
              stack[chk_len - 1][0] = 308;
            }
            break;
          case 308:

            /* rule_XXX_Htype_field_kv_listO_XXX___u163 collect */
            ret_list = [];
            b_0 = start_pos;
            node = this.proxy2;
            node.value_array.clear();
            node.a = start_pos;
            list_1 = FAcache[b_0][0];
            for (idx_1 = _zw = _ref360 = FAcounter[b_0][532], _ref361 = list_1.length; _zw < _ref361; idx_1 = _zw += 1) {
              tok = list_1[idx_1];
              if (tok.value !== "{") {
                continue;
              }
              ...
              old_node = node;
              node = this.proxy;
              for (_i_2 = _zx = 0; _zx < 1; _i_2 = ++_zx) {

                /* NOPE */
                hyp_list_2.push(node.value_array.clone());
              }
              for (_i_2 = _zy = 0; _zy < 1; _i_2 = ++_zy) {
                if (b_1 >= length) {
                  node.value_array.pop();
                  continue;
                }
                list_2 = FAcache[b_1][51];
                for (_zz = 0, _len406 = list_2.length; _zz < _len406; _zz++) {
                  tok = list_2[_zz];
                  b_2 = tok.b;
                  node.value_array.push(tok);
                  hyp_list_2.push(node.value_array.clone());
              ...
              node = old_node;
              for (_aaa = 0, _len407 = hyp_list_2.length; _aaa < _len407; _aaa++) {
                tok_list = hyp_list_2[_aaa];
                node.value_array.append(tok_list);
                b_2 = node.value_array.last().b;
                if (b_2 >= length) {
                  node.value_array.pop();
                ...
                list_3 = FAcache[b_2][0];
                for (_aab = 0, _len408 = list_3.length; _aab < _len408; _aab++) {
                  tok = list_3[_aab];
                  if (tok.value !== "}") {
                    continue;
                  }
                  ...
                  arg_list = node.value_array;
                  mx_hash_stub = node.mx_hash = {};
                  mx_hash_stub.rule = "rule_XXX_Htype_field_kv_listO_XXX___u163";
            ...
            FAcounter[b_0][532] = list_1.length;
            FAcache[start_pos][307].append(ret_list);
        }
      }
    };
